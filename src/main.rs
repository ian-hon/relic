...
pushing and pulling, are implemented."#,
    ...
    for (f, c) in HashMap::<CommandType, clap::Command>::from_iter::<Vec<(CommandType, clap::Command)>>(vec![
        (init, Command::new("init")
        ...
        (branch, Command::new("branch")
            .about("")
        ),
        (stash, Command::new("stash")
